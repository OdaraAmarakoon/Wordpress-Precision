		...
		<div class="row">
			...
			<div class="contact-details">
						<?php if (get_field('footer_contact_details_title', 'option')) : ?>
							<h2 class="footer-subheading"><?php the_field('footer_contact_details_title', 'option'); ?></h2>
						<?php endif; ?>
						<div class="inner">
					...
					<div class="copyrights">
						...
						<p class="maya-wrapper"><a href="https://www.maya.lk/" target="_blank">Website By <img src="<?php echo THEME_IMAGES; ?>logo.png" alt="Maya.lk"></a></p>
					</div>
			</div>
			<?php if ($formID) : ?>
